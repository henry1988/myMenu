...
import com.hmartinez.menu.model.SubCategory;
...
public class MainActivity extends AppCompatActivity {
    ...
    public ArrayList<Category> mockData(){
        ...
        for (int i = 0 ; i < 10 ; i ++){
            products.add(new Product(String.format("Carne %d",i),String.format("Descripción de carne %d", i), "", "10$"));
        }
